# Task 2.18 - Economic Rebalancing

## Objective
Introduce **Economic Rebalancing** so the economic ecosystem becomes strategically richer and sect behavior starts to diverge in meaningful ways.

## Feature Increment
After this task, **Economic Rebalancing** should make specialization, trade, or ecosystem pressure more legible to the player.

## Detailed Requirements
Implement the scope below as production-ready game behavior rather than temporary UI-only placeholders.
- Adjust output and cost values for each sect industry.
- Adjust building costs and effects.
- Adjust the range of market price fluctuation.
- Adjust sect AI decision logic.
- Adjust mortal industry output.
...
## Dependencies
- Build on Task 2.17 before implementation, and preserve all earlier loop guarantees for this phase.
- Keep the feature compatible with the phase exit standard described in README.md for this folder.

## Completion Signal
- The player-facing game loop can demonstrate **Economic Rebalancing** without relying on placeholder-only behavior.
