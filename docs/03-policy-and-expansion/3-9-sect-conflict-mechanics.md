# Task 3.9 - Sect Conflict Mechanics

## Objective
Introduce **Sect Conflict Mechanics** so national governance decisions create realm-wide consequences that must be managed over time.

## Feature Increment
After this task, **Sect Conflict Mechanics** should materially affect how the realm is governed, defended, or expanded.

## Detailed Requirements
Implement the scope below as production-ready game behavior rather than temporary UI-only placeholders.
- Sects can enter conflict over contested resources.
- Conflict affects output and loyalty.
- Conflict can escalate into armed confrontation.
- The player can intervene to mediate.
- Failed mediation escalates the conflict.
...
## Dependencies
- Build on Task 3.8 before implementation, and preserve all earlier loop guarantees for this phase.
- Keep the feature compatible with the phase exit standard described in README.md for this folder.

## Completion Signal
- The player-facing game loop can demonstrate **Sect Conflict Mechanics** without relying on placeholder-only behavior.
