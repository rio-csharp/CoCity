# Task 3.16 - Territorial Expansion System

## Objective
Introduce **Territorial Expansion System** so national governance decisions create realm-wide consequences that must be managed over time.

## Feature Increment
After this task, **Territorial Expansion System** should materially affect how the realm is governed, defended, or expanded.

## Detailed Requirements
Implement the scope below as production-ready game behavior rather than temporary UI-only placeholders.
- The player can open up new regions.
- New regions require development investment.
- New regions begin with low output.
- New regions can attract sect migration.
...
## Dependencies
- Build on Task 3.15 before implementation, and preserve all earlier loop guarantees for this phase.
- Keep the feature compatible with the phase exit standard described in README.md for this folder.

## Completion Signal
- The player-facing game loop can demonstrate **Territorial Expansion System** without relying on placeholder-only behavior.
