# Task 3.6 - Regional Governance System

## Objective
Introduce **Regional Governance System** so national governance decisions create realm-wide consequences that must be managed over time.

## Feature Increment
After this task, **Regional Governance System** should materially affect how the realm is governed, defended, or expanded.

## Detailed Requirements
Implement the scope below as production-ready game behavior rather than temporary UI-only placeholders.
- Each region tracks stability, prosperity, and spiritual concentration.
- Stability affects population growth and output.
- Prosperity affects sect and mortal output.
- Spiritual concentration affects cultivation efficiency.
- Regional attributes can be changed through policy and projects.
...
## Dependencies
- Build on Task 3.5 before implementation, and preserve all earlier loop guarantees for this phase.
- Keep the feature compatible with the phase exit standard described in README.md for this folder.

## Completion Signal
- The player-facing game loop can demonstrate **Regional Governance System** without relying on placeholder-only behavior.
