...
## Objective
Introduce **Achievement System** so the project evolves from a complete simulation into a polished, replayable, release-ready strategy game.

## Feature Increment
After this task, **Achievement System** should improve depth, readability, replay value, or release completeness in a player-visible way.

## Detailed Requirements
Implement the scope below as production-ready game behavior rather than temporary UI-only placeholders.
- Achievements have difficulty tiers such as easy, medium, hard, and extreme.
- Achievements span categories such as economy, military, diplomacy, and exploration.
- Achievements unlock rewards.
- Achievements provide optional long-term goals.
- Achievements can be inspected in-game.
...
## Dependencies
- Build on Task 4.4 before implementation, and preserve all earlier loop guarantees for this phase.
- Keep the feature compatible with the phase exit standard described in README.md for this folder.

## Completion Signal
- The player-facing game loop can demonstrate **Achievement System** without relying on placeholder-only behavior.
