        ...
        public RealmState GetInitialState()
        {
            var regions = ImmutableArray.Create(
                new RegionState(
                    ...
                    TownIds: ImmutableArray.Create("town.azure-ford", "town.gold-reed-market"),
                    SectIds: ImmutableArray.Create("sect.azure-talisman-academy")),
                new RegionState(
                    ...
                    TownIds: ImmutableArray.Create("town.redcliff-garrison"),
                    SectIds: ImmutableArray.Create("sect.iron-peak-hall")),
                new RegionState(
                    ...
                    TownIds: ImmutableArray.Create("town.mistwood-harbor"),
                    SectIds: ImmutableArray.Create("sect.verdant-crucible-sect")));

            var towns = ImmutableArray.Create(
                new MortalTownState(
                    Id: "town.azure-ford",
            ...
            var ministries = ImmutableArray.Create(
                new MinistryState(
                    ...
                    SupportingOfficials: ImmutableArray.Create(
                        new OfficialState(
